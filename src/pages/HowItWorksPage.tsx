...
const steps = [
  { icon: UserPlus, title: 'Sign Up', desc: 'Start your free 7-day trial. No card needed. Takes 2 minutes.' },
  { icon: Users, title: 'Add Your Circle', desc: 'Add emergency contacts. They get instant alerts if you need help.' },
  { icon: Shield, title: 'CLARA Watches Over You', desc: 'CLARA monitors your safety 24/7 via app, voice, or tablet.' },
  { icon: Zap, title: 'Help Arrives Fast', desc: 'Your circle is alerted instantly with your location.' },
];
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Three ways to call for help</h2>
          <p className="text-gray-500 text-lg">However you need it, whenever you need it.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="rounded-2xl p-6 bg-white border border-gray-200 shadow-sm hover:shadow-lg hover:border-red-200 transition-all group">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="inline-flex items-center gap-1 bg-green-50 text-green-700 border border-green-200 text-xs font-semibold px-2.5 py-1 rounded-full"><Check className="w-3 h-3" /> Included</span>
            </div>
          ...
          <div className="rounded-2xl p-6 bg-white border border-gray-200 shadow-sm hover:shadow-lg hover:border-amber-200 transition-all group">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="inline-flex items-center gap-1 bg-amber-50 text-amber-700 border border-amber-200 text-xs font-semibold px-2.5 py-1 rounded-full">+ Optional</span>
            </div>
            ...
            <p className="text-sm text-gray-500 leading-relaxed">Waterproof Bluetooth pendant. 6-month battery. Separate one-time purchase.</p>
            <p className="text-xs text-amber-700 bg-amber-50 rounded-lg px-3 py-2 mt-3 border border-amber-200">The pendant is optional. App SOS and voice activation are included free.</p>
          </div>
          <div className="rounded-2xl p-6 bg-white border border-gray-200 shadow-sm hover:shadow-lg hover:border-red-200 transition-all group">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">Fixed tablet at home. CLARA monitors activity and responds to voice. Use any tablet.</p>
          </div>
        </div>
        <div className="max-w-5xl mx-auto mt-6">
          <div className="bg-white rounded-2xl border border-gray-200 p-5 flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-sm">Say "CLARA, help me" hands-free from your phone, tablet, or anywhere CLARA is listening.</p>
            </div>
            <span className="text-xs bg-green-50 text-green-700 border border-green-200 px-3 py-1.5 rounded-full font-medium flex-shrink-0 hidden sm:inline-flex items-center gap-1"><Check className="w-3 h-3" /> Included</span>
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="py-16 sm:py-20 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center mb-12">
          <span className="text-red-500 text-xs font-semibold uppercase tracking-widest mb-3 block">What you get</span>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">Everything in your plan</h2>
          <p className="text-gray-500 text-base">€9.99/month — one price, complete protection</p>
        </div>
        <div className="bg-gray-100 rounded-3xl overflow-hidden flex flex-col gap-px">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px">
            <div className="bg-white p-8 hover:bg-red-50/30 transition-colors group cursor-pointer relative overflow-hidden">
              ...
              <span className="text-red-500 text-xs font-semibold uppercase tracking-widest mb-4 block">Core feature</span>
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">CLARA AI — 24/7</h3>
              <p className="text-gray-500 text-sm leading-relaxed max-w-xs">Your personal AI safety companion. Always listening, always ready to coordinate your emergency response.</p>
            </div>
            <div className="bg-white p-8 hover:bg-red-50/30 transition-colors group cursor-pointer relative overflow-hidden">
              ...
              <span className="text-red-500 text-xs font-semibold uppercase tracking-widest mb-4 block">Always with you</span>
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">One-tap App SOS</h3>
              <p className="text-gray-500 text-sm leading-relaxed max-w-xs">Press once from anywhere. Your full emergency circle alerted instantly with your live location.</p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px">
            <Tile icon={Mic} title="Voice activation" desc='"CLARA, help me" — hands-free from phone, tablet or smart speaker.' />
            <Tile icon={MapPin} title="Live GPS location" desc="Real-time coordinates shared every 30 seconds during any emergency." />
            <Tile icon={Phone} title="Conference bridge" desc="Family joins a live call together the moment SOS fires." />
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px">
            <div className="sm:col-span-2 bg-white p-8 hover:bg-red-50/30 transition-colors group cursor-pointer flex items-center gap-6">
              ...
              <div><span className="text-red-500 text-xs font-semibold uppercase tracking-widest mb-2 block">Always home</span><h3 className="text-lg font-bold text-gray-900 mb-1">Tablet dashboard</h3><p className="text-gray-500 text-sm leading-relaxed">Fixed tablet at home. Always-on CLARA monitoring, voice activated, family messages. Use any tablet — no extra cost.</p></div>
            </div>
            <div className="bg-white p-6 hover:bg-red-50/30 transition-colors group cursor-pointer">
              ...
              <h4 className="font-bold text-gray-900 text-sm mb-2">Medical profile</h4>
              <p className="text-gray-500 text-xs leading-relaxed">Blood type, allergies and medications sent automatically to first responders.</p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px">
            <Tile icon={Users} title="Family circle" desc="Up to 5 emergency contacts. 1st family link free with your plan." />
            <Tile icon={Headphones} title="Instant callback" desc="No response in 60 seconds? A real person calls you back immediately." />
            <Tile icon={Star} title="7-day free trial" desc="Full access, no card required. Try everything before you commit." />
          </div>
          <div className="bg-amber-50 hover:bg-amber-100/60 transition-colors p-6 flex items-center gap-5 cursor-pointer">
            ...
            <div className="flex-1">
              <div className="flex items-center flex-wrap gap-2 mb-1"><h4 className="font-bold text-gray-900 text-sm">SOS Pendant</h4><span className="text-xs bg-amber-100 text-amber-700 border border-amber-200 px-2.5 py-0.5 rounded-full font-medium">Optional — not included</span></div>
              <p className="text-gray-500 text-xs leading-relaxed">Waterproof Bluetooth pendant. 6-month battery. Separate one-time purchase.</p>
            </div>
            <div className="text-right flex-shrink-0 hidden sm:block"><p className="font-bold text-amber-700 text-base">~€49.99</p><p className="text-xs text-amber-600">one-time</p></div>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px">
            <div className="bg-white p-5 hover:bg-blue-50/40 transition-colors cursor-pointer"><Activity className="w-5 h-5 text-blue-500 mb-3" /><span className="text-xs bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-full font-medium mb-2 block w-fit">Add-on · €2.99/mo</span><h4 className="font-bold text-gray-900 text-xs mb-1">Daily Wellbeing</h4><p className="text-gray-500 text-xs leading-relaxed">CLARA checks in daily. Mood, sleep, pain tracked.</p></div>
            <div className="bg-white p-5 hover:bg-blue-50/40 transition-colors cursor-pointer"><Clock className="w-5 h-5 text-blue-500 mb-3" /><span className="text-xs bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-full font-medium mb-2 block w-fit">Add-on · €2.99/mo</span><h4 className="font-bold text-gray-900 text-xs mb-1">Medication Reminder</h4><p className="text-gray-500 text-xs leading-relaxed">Reminders, dose logging, family alerts if missed.</p></div>
            <div className="bg-green-50/70 hover:bg-green-100/60 transition-colors cursor-pointer p-5"><Star className="w-5 h-5 text-green-600 mb-3" /><span className="text-xs bg-green-100 text-green-700 border border-green-200 px-2 py-0.5 rounded-full font-medium mb-2 block w-fit">Free — auto unlocked</span><h4 className="font-bold text-gray-900 text-xs mb-1">CLARA Complete</h4><p className="text-gray-500 text-xs leading-relaxed">Get both add-ons — weekly AI reports free.</p></div>
            <div className="bg-white p-5 hover:bg-red-50/30 transition-colors cursor-pointer"><Gift className="w-5 h-5 text-red-500 mb-3" /><span className="text-xs bg-green-50 text-green-700 border border-green-200 px-2 py-0.5 rounded-full font-medium mb-2 block w-fit">Included free</span><h4 className="font-bold text-gray-900 text-xs mb-1">Referral programme</h4><p className="text-gray-500 text-xs leading-relaxed">Refer 5 friends — earn 12 months free.</p></div>
          </div>
        </div>
        <div className="text-center mt-10">
          <Button onClick={() => navigate('/onboarding')} className="bg-red-500 hover:bg-red-600 text-white px-8 py-4 rounded-full font-semibold text-base shadow-lg shadow-red-500/20 h-auto">Start your free trial →</Button>
          <p className="text-gray-400 text-sm mt-3">No card required · 7 days free · Cancel anytime</p>
        </div>
      </div>
    </section>
  );
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-10">
          <span className="inline-flex items-center gap-2 bg-red-50 text-red-600 text-xs font-semibold px-4 py-1.5 rounded-full border border-red-100 mb-4">In the next 30 seconds</span>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">What happens the moment you press SOS</h2>
          <p className="text-gray-500 max-w-xl mx-auto">CLARA coordinates everything instantly — you just need to press one button.</p>
        </div>
  ...
  return (
    <section className="py-20 bg-gray-900">
      <div className="container mx-auto px-4 text-center max-w-2xl">
        ...
        <p className="text-sm text-gray-400">7-day free trial · No card required · Cancel anytime</p>
      </div>
    </section>
  );
}
