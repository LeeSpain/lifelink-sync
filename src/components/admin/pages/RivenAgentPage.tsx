    ...
    <div className="px-8 py-6 w-full space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Riven AI Agent</h1>
            <p className="text-muted-foreground">Complete AI marketing engine - content, campaigns, platforms, and performance</p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap gap-2">
        <Badge variant="outline">Model: {settings.aiModel}</Badge>
        <Badge variant={settings.autoApproveContent ? 'default' : 'secondary'}>
          Auto-Approve: {settings.autoApproveContent ? 'ON' : 'OFF'}
        </Badge>
        <Badge variant="outline">Temp: {settings.temperature}</Badge>
        <Badge variant="outline">Max Tokens: {settings.maxTokens.toLocaleString()}</Badge>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="px-8 py-6 w-full space-y-4">
        <TabsList className="grid w-full grid-cols-8">
          ...
          <TabsTrigger value="angles">Content Engine</TabsTrigger>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="text-2xl font-bold">{metrics.publishedContent}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="text-2xl font-bold">{metrics.scheduledContent}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="text-2xl font-bold">{metrics.platformsActive}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <TableBody>
                    {campaignStats.map((c, i) => (
                      <TableRow key={i}>
                        ...
                        <TableCell><Badge variant="secondary" className="text-xs">{c.posts}</Badge></TableCell>
                        <TableCell>
                ...
                <div className="px-8 py-6 w-full space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1"
                    />
                    <p className="text-xs text-muted-foreground">Maximum response length per generation</p>
                  </div>
                </div>
                ...
                <div className="px-8 py-6 w-full space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1"
                    />
                    <p className="text-xs text-muted-foreground">Default budget for new campaigns</p>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label>Provider</Label>
                      <div className="mt-1 text-sm font-medium">Anthropic</div>
                    </div>
                    <div>
                      <Label>API Key</Label>
                      <Badge className="mt-1 bg-emerald-500/10 text-emerald-600 border-emerald-500/20">Configured</Badge>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="angles" className="px-8 py-6 w-full space-y-4">
              ...
              <div className="space-y-2">
                {hooks.map((hook, i) => (
                  <div key={hook.style} className="flex items-center justify-between py-2 border-b last:border-0">
                    ...
                    <Badge variant="outline" className="text-xs font-mono">{hook.style}</Badge>
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Call-to-Action Types</CardTitle>
                ...
                {platforms.map((plat, i) => (
                  <div key={plat.platform} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge
                        variant="outline"
                        className={`text-xs ${plat.enabled
                    ...
                    {plat.enabled && (
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <div>
                          <Label className="text-xs text-muted-foreground">Max Hashtags</Label>
                          <Input
                            type="number"
                        ...
                        <div>
                          <Label className="text-xs text-muted-foreground">Best Times</Label>
              ...
              <div className="px-8 py-6 w-full space-y-4">
                {platforms.filter(p => p.enabled && p.postsPerDay > 0).map((plat, i) => (
                  <div key={plat.platform} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm font-semibold capitalize">{plat.platform}</span>
                      <Badge variant="secondary" className="text-xs">{plat.postsPerDay} posts/day</Badge>
                    </div>
                    <div className="flex flex-wrap gap-2">
            ...
            <CardContent className="px-8 py-6 w-full space-y-4">
              <div className="flex items-center justify-between py-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Skip manual review and publish directly when scheduled</p>
                </div>
                <Switch
                  checked={settings.autoApproveContent}
                  onCheckedChange={(v) => setSettings(s => ({ ...s, autoApproveContent: v }))}
              ...
              <div className="flex items-center justify-between py-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Cron job that publishes scheduled content at posting times</p>
                </div>
              ...
              <div className="flex items-center justify-between py-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Receive a daily email summary of published and failed posts</p>
                </div>
                <Badge className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20">Via Resend</Badge>
              </div>
              <div className="flex gap-2 pt-2">
                <Button onClick={saveSettings} disabled={saving}>
                  <Save className="h-4 w-4 mr-2" /> Save Schedule Settings
                </Button>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="performance" className="px-8 py-6 w-full space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Content Generation vs Publishing (30 days)</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Content Angles Used</CardTitle>
              </CardHeader>
              <CardContent>
                {angleDist.length > 0 ? (
                  <div className="h-[220px]">
            ...
            <CardContent className="px-8 py-6 w-full space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Target word count for generated content</p>
                </div>
                <div className="space-y-2">
                  <Label>API Timeout (seconds)</Label>
                  <Input type="number" defaultValue={50} className="h-8" />
                  <p className="text-xs text-muted-foreground">Max wait time for AI response</p>
                </div>
                <div className="space-y-2">
                  <Label>Batch Size</Label>
                  <Input type="number" defaultValue={5} className="h-8" />
                  <p className="text-xs text-muted-foreground">Content pieces generated per API call</p>
                </div>
                <div className="space-y-2">
                  <Label>Daily Publish Limit</Label>
                  <Input type="number" defaultValue={50} className="h-8" />
                  <p className="text-xs text-muted-foreground">Max posts the daily publisher handles per run</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="px-8 py-6 w-full space-y-4">
              <div className="flex items-center justify-between py-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Generate meta descriptions, keywords, slugs, and alt text</p>
                </div>
              ...
              <div className="flex items-center justify-between py-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Create URL-friendly slugs from content titles</p>
                </div>
                <Badge className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20">Enabled</Badge>
              </div>
              <div className="flex items-center justify-between py-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Estimate reading time for blog posts</p>
                </div>
                <Badge className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20">Enabled</Badge>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Remove all unpublished draft content</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Clear content angle usage history</p>
                </div>
                <Button variant="outline" size="sm" className="text-red-500 border-red-500/20 hover:bg-red-500/10">
