  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-inter ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        guardian: "bg-gradient-guardian text-guardian-foreground hover:bg-guardian/90 shadow-guardian transition-all duration-300",
        wellness: "bg-gradient-wellness text-wellness-foreground hover:opacity-90 border border-wellness/20 shadow-wellness transition-all duration-300 hover:shadow-wellness-glow",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-lg transition-all duration-300",
        accent: "bg-accent-red text-accent-red-foreground hover:bg-accent-red/90 transition-all duration-300",
