      ...
      <div className="max-w-2xl mx-auto px-4 pt-8 pb-16">
            ...
            <div className="grid gap-4">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 text-2xl">
                    🙋
                  </div>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 text-2xl">
                    ❤️
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-gray-900 mb-1">
                    ...
                    <p className="text-gray-500 text-sm">
                      I'll set up and manage CLARA for a family member
                    </p>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-300 group-hover:text-red-400 transition-colors" />
                </div>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0 text-2xl">
                    🎁
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-gray-900 mb-1">
                    ...
                    <p className="text-gray-500 text-sm">
                      Buy a gift subscription for someone special — no account needed
                    </p>
                  </div>
        ...
        {step === 1 && (
          <div>
            ...
            <button
              onClick={() => setStep(0)}
              className="mt-6 text-gray-400 text-sm mx-auto block hover:text-gray-600"
            >
              ← Back
            </button>
          </div>
        ...
        {step === 2 && (
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500">
                Powerful extras. Cancel any add-on anytime.
              </p>
            </div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-5">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      Extra family members who receive your SOS alerts
                    </p>
                    <p className="text-xs text-green-600 mt-1">
                      1st link already FREE with your plan
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-3 mt-3">
                  <button
                    onClick={() => setAddons(a => ({
                      ...a,
                      familyLinks: Math.max(0, a.familyLinks - 1)
                    }))}
                  ...
                  <button
                    onClick={() => setAddons(a => ({
                      ...a,
                      familyLinks: Math.min(10, a.familyLinks + 1)
                    }))}
                    className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50"
                  >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1 pr-4">
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      CLARA checks in daily. Tracks mood, sleep & pain. Sends digest to family.
                    </p>
                  ...
                  <button
                    onClick={() => setAddons(a => ({
                      ...a,
                      dailyWellbeing: !a.dailyWellbeing
                    }))}
                    className={`relative w-12 h-6 rounded-full transition-all flex-shrink-0
                      ${addons.dailyWellbeing ? 'bg-red-500' : 'bg-gray-300'}`}
                  >
                    <div className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-all
                      ${addons.dailyWellbeing ? 'left-6' : 'left-0.5'}`} />
                  </button>
                </div>
              </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1 pr-4">
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      CLARA reminds you to take medication. Logs it. Alerts family if missed.
                    </p>
                    <span className="text-red-600 font-semibold text-sm">
                      €2.99/month
                    </span>
                  ...
                  <button
                    onClick={() => setAddons(a => ({
                      ...a,
                      medicationReminder: !a.medicationReminder
                    }))}
                    className={`relative w-12 h-6 rounded-full transition-all flex-shrink-0
                      ${addons.medicationReminder ? 'bg-red-500' : 'bg-gray-300'}`}
                  >
                    <div className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-all
                      ${addons.medicationReminder ? 'left-6' : 'left-0.5'}`} />
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-4 mb-6 flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-green-800">
                    🎉 CLARA Complete unlocked!
                  </p>
                  <p className="text-green-600 text-sm">
                    Weekly AI wellbeing reports included — no extra charge
                  </p>
                </div>
              </div>
            )}
            ...
            {plan === 'individual' && (
              <div className="bg-gray-50 rounded-2xl p-4 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  {addons.familyLinks > 0 && (
                    <div className="flex justify-between text-sm text-gray-600">
                      <span>Family Links ×{addons.familyLinks}</span>
                      <span>€{(addons.familyLinks * 2.99).toFixed(2)}</span>
                    </div>
                  )}
            ...
            <Button
              onClick={() => setStep(3)}
              className="w-full bg-red-500 hover:bg-red-600 text-white py-3 rounded-xl mb-3"
            >
              Continue →
            </Button>
            <button
              onClick={() => setStep(1)}
              className="text-gray-400 text-sm mx-auto block hover:text-gray-600"
            >
              ← Back
            </button>
          </div>
        ...
        {step === 3 && (
          <div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e => setProtectedEmail(e.target.value)}
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  For WhatsApp updates from CLARA
                </p>
              </div>
                ...
                {showReferral && (
                  <div className="mt-2">
                    <Input
                      ...
                      placeholder="e.g. CLARA4X8K"
                    />
                    {referralCode && (
                      <p className={`text-xs mt-1 ${referralValid ? 'text-green-600' : 'text-red-500'}`}>
                        {referralValid
                          ? '✅ Referral applied!'
                          : '❌ Code not found'}
                      </p>
              ...
              <div className="pt-2 space-y-3 border-t border-gray-100">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-600">
                    I agree to the{' '}
                    <a href="/privacy" className="text-red-500 underline" target="_blank" rel="noreferrer">
                      Privacy Policy
                    </a>
                    {' '}and{' '}
                    <a href="/terms" className="text-red-500 underline" target="_blank" rel="noreferrer">
                      Terms of Service
                    </a>
                    {' '}*
                  </span>
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-600">
                    I consent to receive safety-related emails from LifeLink Sync *
                  </span>
                </label>
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-600">
                    I'd like to receive news and offers (optional)
                  </span>
                </label>
              </div>
            </div>
            ...
            <button
              onClick={() => setStep(2)}
              className="mt-4 text-gray-400 text-sm mx-auto block hover:text-gray-600"
            >
              ← Back
            </button>
          </div>
          ...
          <div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-6 flex items-center gap-3">
              ...
              <p className="text-amber-800 text-sm">
                <strong>Trial starts today.</strong>
                {' '}First charge of €{total.toFixed(2)} on{' '}
              ...
              {[
                {
                  ...
                  desc: 'Who should CLARA alert?',
                  path: '/member-dashboard/profile'
                },
                {
                  emoji: '🏥',
                  title: 'Set up medical profile',
                  desc: 'Blood type, allergies, medications',
                  path: '/member-dashboard/profile'
                },
                {
                  emoji: '📱',
                  title: 'Get the app',
                  desc: 'Install CLARA on your phone',
                  path: '/member-dashboard/products'
                },
              ].map(item => (
                <button
                  key={item.title}
