-- Enable realtime for video_analytics table
...
-- Fix the get_video_analytics_summary function to properly count countries
CREATE OR REPLACE FUNCTION public.get_video_analytics_summary()
RETURNS TABLE(video_id text, video_title text, total_views bigint, total_watch_time_minutes numeric, avg_watch_time_minutes numeric, completion_rate numeric, unique_viewers bigint, top_countries jsonb)
LANGUAGE sql
