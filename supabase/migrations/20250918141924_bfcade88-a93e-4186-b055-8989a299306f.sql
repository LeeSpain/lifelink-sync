...
DROP POLICY IF EXISTS "System can manage video analytics" ON public.video_analytics;
...
DROP POLICY IF EXISTS "Public can insert selections" ON public.registration_selections;
